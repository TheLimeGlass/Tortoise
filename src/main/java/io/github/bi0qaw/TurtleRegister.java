...
public class TurtleRegister {
	...
	static {
		...
		// Effects
		Skript.registerEffect(EffAlignAxis.class, "align (0¦forward|1¦backward|2¦upward|3¦downward|4¦right[ward]|5¦left[ward])(-| )axis of %turtle% with %vector%");
		Skript.registerEffect(EffMoveTurtle.class, "(0¦move|1¦rotate) %turtles%[ by][ ]%number%,[ ]%number%,[ ]%number%");
